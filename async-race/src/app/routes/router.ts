...
//   private currentRouter: Routes | null;
//   constructor() {
...
//     (document.querySelector('#app') as HTMLElement).textContent = '';
//     (document.querySelector('#app') as HTMLElement).append(
//       (component as class).render()
//     );
//   }
// }
